function [launch_RA,launch_lat,lunar_posAtarrival,lunar_velAtarrival,launch_dateUTC] = launchwindow_j2000(algorithm_dateUTC,TOF)
%% Revision history
%   - 2023/04/08, by 은별
%   - 2023/04/10, by 동민
%   - 2023/04/21, by 은별
...
for i = 1:length(lunar_RA)
    ...
    if abs ( reverse_lunarRA  - ra_j2000_adj ( i ) ) < tol
            ...
            launch_argper(dateNum)             =   -lunar_argper ( i );
