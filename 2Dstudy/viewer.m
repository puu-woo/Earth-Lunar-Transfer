...
theta_init2 = IConditions.Earth.theta;
...
xlabel('km');
ylabel('km');
title(['Moon Center','  (\theta=',num2str(theta_init2*180/pi),'\circ)'],Color='white');
...
xlabel('km');
ylabel('km');
title(['Moon Center, Near','  (\theta=',num2str(theta_init2*180/pi),'\circ)'],Color='white');
set(gca,'color',[0.2,0.2,0.2],'XColor',[0.8,0.8,0.8],'YColor',[0.8,0.8,0.8])
grid on
...
title(['Earth Center','  (\theta=',num2str(theta_init2*180/pi),'\circ)'],Color='white');
