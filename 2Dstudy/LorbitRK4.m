function [y,min_distance,T,lunar_position,lunar_velocity] = LorbitRK4(dt,y0,lunar_posATinj)
    ...
    while true
        ...
        r1l = r1e-lp;
        v1 = y(4:6,i-1);
        a1 = - mu_lunar / sum ( r1l.^2 )^(1.5) * r1l - mu_earth / sum ( r1e.^2 )^(1.5) * r1e;
        k1 = dt*[v1;a1];
        ...
        r2l = r2e-lp;
        v2 = v1+0.5*k1(4:6);
        a2 = - mu_lunar / sum ( r2l.^2 )^(1.5) * r2l - mu_earth / sum ( r2e.^2 )^(1.5) * r2e;
        k2 = dt*[v2;a2];
        ...
        r3l = r3e-lp;
        v3 = v1+0.5*k2(4:6);
        a3 = - mu_lunar / sum ( r3l.^2 )^(1.5) * r3l - mu_earth / sum ( r3e.^2 )^(1.5) * r3e;
        k3 = dt*[v3;a3];
        ...
        r4l = r4e-lp;
        v4 = v1+k3(4:6);
        a4 = - mu_lunar / sum ( r4l.^2 )^(1.5) * r4l  - mu_earth / sum ( r4e.^2 )^(1.5) * r4e;
        k4 = dt*[v4;a4];
